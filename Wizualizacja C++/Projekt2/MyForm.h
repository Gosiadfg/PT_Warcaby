...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(492, 155);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Cambria", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->button3->Location = System::Drawing::Point(492, 117);
			...
			this->ClientSize = System::Drawing::Size(749, 478);
...
#pragma endregion
	...
	private:
		Void button3_Click(Object^  sender, EventArgs^  e) {
			...
			array<Bitmap^, 2> ^bmps = gcnew array<Bitmap^, 2>(10, 10);
			for (int i = 0; i < 8; i++)
				for (int j = 0; j < 8; j++)
				{
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		array<int, 2> ^macierz = gcnew array<int, 2>(8, 8);
		for (int i = 0; i < 8; i++)
		{
			for (int j = 0; j < 8; j++)
			{
